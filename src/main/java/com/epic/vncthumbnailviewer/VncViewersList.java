    ...
    private void saveHosts(boolean isEncrypted, String filename, String encPassword) {
        ...
        while (l.hasNext()) {
            ...
            if (isEncrypted) {
                ...
                if (sectype == "-6")
                    username = DesCipher.encryptData(username, encPassword); //userdomain = encryptData(userdomain,encPassword);
            ...
            if (sectype == "2" || sectype == "-6") {
                ...
                if (sectype == "-6")
                    c.setAttribute("Username", username); //c.setAttribute("UserDomain", userdomain);
            }
