...
class RfbProto {
    ...
    final static String StandardVendor = "STDV",
            TridiaVncVendor = "TRDV",
            UltraVncVendor = "UVNC", // MS-Logon
            TightVncVendor = "TGHT";

    // Security types
    final static int SecTypeInvalid = 0,
            SecTypeNone = 1,
            SecTypeVncAuth = 2,
            SecTypeTight = 16,
    ...
    final static int AuthNone = 1,
            AuthVNC = 2,
            AuthMSL = -6, // MS-Logon
            AuthUnixLogin = 129;
    final static String SigAuthNone = "NOAUTH__",
            SigAuthVNC = "VNCAUTH_",
