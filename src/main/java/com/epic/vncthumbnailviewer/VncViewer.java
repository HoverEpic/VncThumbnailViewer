        ...
        switch (authType) {
            ...
            case RfbProto.AuthVNC:
                ...
                if (rfb.serverMinor == 4 && rfb.clientMinor == 4) { // MS-Logon
                    ...
                    if (us == null) // MS-Logon
                        throw new Exception("Username not specified, could not complete logon"); // MS-Logon // MS-Logon
            ...
            case RfbProto.AuthMSL: // MS-Logon
                ...
                if (passwordParam != null && usernameParam != null) // MS-Logon
                    ...
                    throw new Exception("Username or Password not specified, could not complete MS-Logon"); // MS-Logon // MS-Logon
                break; // MS-Logon
            default:
